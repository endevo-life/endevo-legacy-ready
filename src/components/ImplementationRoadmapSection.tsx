...
const steps = [
  ...
  },
  {
    ...
    description:
      "Flexible modules designed to fit into a busy professional schedule.",
  },
  {
    number: "03",
  ...
  },
  {
    ...
    description:
      "Specialized support to ensure all deliverables (legal, financial, and digital) are finalized.",
  },
  {
    number: "05",
...
const ImplementationRoadmapSection = () => {
  ...
  return (
    <section className="py-16 md:py-20 bg-white">
      <div ref={elementRef} className="container mx-auto px-6 md:px-12">
        {/* Header */}
        <div
