...
const ServiceProvidersHeroSection = () => {
  ...
  return (
    <section
      ...
      style={{
        backgroundImage: `url('https://assets.cdn.filesafe.space/f5ehsbHfdFg2UsHEIb49/media/699757fe3ff516492351e741.png')`,
      }}
    >
      ...
      <div className="container px-4 md:px-8 lg:px-16 text-left relative z-10">
        ...
        >
          Be part of a 126 billion dollar
          <br />
        ...
        >
          Partner with ENDevo to reach more clients, showcase your expertise,
        ...
        >
          <Button
            ...
            onClick={() =>
              (window.location.href = "/marketplace#legal-collaboration")
            }
          >
            Join Our Network
          </Button>
