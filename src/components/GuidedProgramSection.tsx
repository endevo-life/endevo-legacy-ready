  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-20 right-10 w-80 h-80 bg-emerald-100/30 rounded-full blur-3xl" />
      </div>
      ...
      <div className="container max-w-6xl mx-auto px-4 relative z-10">
        ...
        <div className={`text-center mb-16 transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          ...
          <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold text-slate-800 mb-4">
            A Guided Path to <span className="text-teal-600">Preparedness</span>
          </h2>
                ...
                <div className="relative group h-full">
                  ...
                  <div className="bg-white rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 p-6 h-full border border-slate-100 relative overflow-hidden">
                    ...
                    <div className="relative z-10 mb-4">
                      <span className="text-4xl font-bold text-teal-600/20">{step.number}</span>
                    </div>

                    {/* Icon */}
                    <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-teal-500 to-teal-600 flex items-center justify-center mb-4 group-hover:scale-110 transition-transform duration-300">
                    ...
                    {/* Bottom accent line */}
                    <div className="absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r from-teal-500/0 via-teal-500/50 to-teal-500/0 opacity-0 group-hover:opacity-100 transition-opacity duration-300" />
                  </div>

                  {/* Arrow to next step - Mobile */}
                  {index < steps.length - 1 && (
                    <div className="flex justify-center py-4 md:hidden">
                      <svg width="24" height="24" viewBox="0 0 24 24" fill="none" className="text-teal-400 rotate-90">
        ...
        <div className={`text-center mt-14 transition-all duration-700 delay-500 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <a 
            ...
            className="inline-flex items-center gap-2 bg-gradient-to-r from-teal-600 to-teal-500 text-white px-8 py-4 rounded-full font-semibold shadow-lg hover:shadow-xl hover:from-teal-700 hover:to-teal-600 transition-all duration-300 group"
          >
