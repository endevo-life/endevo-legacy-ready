          ...
          {!showDetails ? (
            ...
            <div className="space-y-4">
              <p className="text-gray-700 dark:text-gray-300">
                ...
                improve functionality, analyze usage, and deliver personalized wellness content. 
              ...
              <div className="bg-brand-teal/10 border border-brand-teal/30 rounded-lg p-4">
                <p className="text-sm text-gray-700 dark:text-gray-300">
                  <strong className="text-brand-teal">Privacy First:</strong> Essential cookies are always active. 
                  You control everything else. Learn more in our{' '}
                  <a href="/legal/cookie-policy" className="text-brand-orange underline hover:no-underline">
                    Cookie Policy
                  </a>{' '}
                  and{' '}
                  <a href="/legal/privacy-policy" className="text-brand-orange underline hover:no-underline">
                    Privacy Policy
                  </a>.
                </p>
              </div>
            ...
            <div className="space-y-6">
              ...
              <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  Essential for platform security, authentication, and core functionality. 
              ...
              <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  Remember your preferences like language, theme, and accessibility settings 
              ...
              <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  Help us understand how you use endevo.life so we can improve performance, 
                  fix bugs, and enhance your experience. Includes Google Analytics (anonymized IP).
                </p>
              </div>
              ...
              <div className="border border-gray-200 dark:border-gray-700 rounded-lg p-4">
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  ...
                  Includes social media pixels and retargeting for personalized marketing.
                </p>
              </div>
            </div>
          )}
