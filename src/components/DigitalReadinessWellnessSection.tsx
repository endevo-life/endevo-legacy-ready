...
const highlights = [
  {
    ...
    description:
      "Support that activates based on real life events, not a fixed schedule. Whether an employee is planning ahead or in crisis, the program responds.",
  },
  {
    icon: Calendar,
    title: "Contained. Measurable. Expandable.",
    description:
      "Start with a defined employee group, prove outcomes, then scale. No long-term commitment required.",
  },
  {
    icon: BarChart2,
    title: "Data-backed ROI",
    description:
      "Track absenteeism, productivity loss, and HR escalations before and after. Built for your business case.",
  },
];
...
const DigitalReadinessWellnessSection = () => {
  ...
  return (
    <section ref={elementRef} className="bg-muted/20 py-20">
      <div className="container max-w-6xl mx-auto px-4">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground leading-relaxed max-w-5xl mx-auto">
            Our comprehensive employee wellness program helps employees complete
            critical life and digital planning decisions before a crisis occurs.
            By combining step-by-step roadmap, 1:1 accountability and
            productivity tools, we reduce the feelings of overwhelm while
            ensuring life stories and digital footprints are protected,
        ...
        <div className="flex justify-center gap-4 mt-10">
          <Button
            onClick={() =>
              window.open(
                "https://link.endevo.life/widget/booking/HUYkq6QZs0fI7AMtt6qH",
                "_blank",
              )
            }
