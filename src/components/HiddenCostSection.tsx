...
import familyUnprepared from "@/assets/hidden-cost-unprepared.jpg";
          ...
          <div className="space-y-8 flex flex-col justify-center h-full">
            ...
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed">
                Most Americans are unprepared. Without end-of-life planning, families face chaos, expensive legal issues, unclear asset distribution, disputes, locked accounts, and even lost business revenue, and many end up facing more than <strong className="text-foreground italic">$10,000 in unexpected costs</strong>.
              </p>
            </div>
