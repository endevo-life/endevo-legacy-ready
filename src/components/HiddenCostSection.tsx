          ...
          <div className="space-y-8">
            ...
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed">
                Most Americans are unprepared. Without end-of-life planning, families face chaos, expensive legal issues, unclear asset distribution, disputes, locked accounts, and even lost business revenue, and many end up facing <strong className="text-foreground">more than $10,000 in unexpected costs</strong>.
              </p>
            </div>
