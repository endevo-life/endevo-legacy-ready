      ...
      <div ref={elementRef as any} className="relative z-10 container max-w-5xl mx-auto px-4 text-center text-white">
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-6 md:gap-12">
          <a 
            ...
            className={`text-white hover:text-brand-orange text-base md:text-lg font-medium transition-all duration-300 hover:scale-105 underline decoration-2 underline-offset-4 decoration-white hover:decoration-brand-orange ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`} 
            style={{
          ...
          <a href="#" className={`text-white hover:text-brand-orange text-base md:text-lg font-medium transition-all duration-300 hover:scale-105 underline decoration-2 underline-offset-4 decoration-white hover:decoration-brand-orange ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`} style={{
