...
const HiddenCostStatsSection = () => {
  ...
  return <section ref={elementRef} className="py-20 bg-muted/30">
      ...
      }}>Major life events don't pause work. Without preparation, they create stress, disruption, and lost productivity across teams. <span className="font-bold">ENDevo helps organizations proactively support employees before life disruptions turn into workplace challenges.</span></p>
