        ...
        <div className="max-w-3xl">
          ...
          <div className="space-y-8">
            ...
            transitionDelay: isVisible ? '0.2s' : '0s'
              ...
              <a href="/wws-for-employers" className="text-brand-orange hover:text-brand-orange-dark font-semibold text-lg transition-colors">
                Learn More
              </a>
            </div>
            ...
            transitionDelay: isVisible ? '0.6s' : '0s'
              ...
              <a href="/wws-individuals" className="text-brand-orange hover:text-brand-orange-dark font-semibold text-lg transition-colors">
                Get Started
              </a>
            </div>
          </div>
