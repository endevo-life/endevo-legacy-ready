  ...
  return <section className="py-16 md:py-20 bg-muted/30">
      <div className="container max-w-6xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-6 mb-12">
          {categoryInfo.map((category, index) => <button key={index} onClick={() => toggleCategory(category.category)} className={`text-left transition-all hover:shadow-lg ${selectedCategories.includes(category.category) ? 'ring-2 ring-brand-orange' : ''}`}>
