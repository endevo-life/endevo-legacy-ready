            ...
            <div className="prose prose-lg max-w-none">
              <div className="mb-12">
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  Welcome to ENDevo Services ("ENDevo," "we," "us," or "our").
                  These Terms of Service ("Terms") govern your access to and use
                  of our website, mobile application, digital legacy readiness
                  tools, assessments, and related services (collectively, the
                  "Services").
                </p>
                <p className="text-gray-700 leading-relaxed mb-4">
              ...
              <div className="mb-12">
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  ...
                  using the Services, you represent and warrant that you are at
                ...
                <h3 className="text-xl font-semibold text-brand-teal mb-3">
                  1.3 Account Suspension or Termination
                </h3>
                <p className="text-gray-700 leading-relaxed">
                  We reserve the right to suspend or terminate your account at
                  any time, with or without notice, for violation of these
                  Terms, fraudulent activity, or any other reason we deem
              ...
              <div className="mb-12">
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  ENDevo provides digital legacy readiness services, including
                  but not limited to:
                </p>
                <ul className="list-disc pl-6 mb-6 space-y-2 text-gray-700">
                  ...
                  <li>
                    Educational resources and content about end-of-life planning
                  </li>
                  <li>
                    Connection services to qualified professional service
                    providers
                  </li>
                ...
                <div className="bg-brand-orange/10 border-l-4 border-brand-orange p-6 rounded-r-lg">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    ENDevo provides tools, resources, and guidance to help you
                    with legacy planning. However, we do not provide legal,
                    financial, tax, or medical advice. Our Services are not a
                    substitute for professional advice from qualified attorneys,
                    financial advisors, accountants, or healthcare providers.
                    You should consult with appropriate professionals for
              ...
              <div className="mb-12">
                ...
                <ul className="list-disc pl-6 mb-4 space-y-2 text-gray-700">
                  ...
                  <li>
                    Respect the intellectual property rights of ENDevo and
                    others
                  </li>
                  ...
                  <li>
                    Not use automated systems (bots, scrapers) without our
                    permission
                  </li>
                  <li>Not transmit viruses, malware, or other harmful code</li>
                  <li>Not harass, abuse, or harm other users</li>
                  <li>
                    Not upload false, misleading, or fraudulent information
                  </li>
                </ul>
              </div>
              ...
              <div className="mb-12">
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  ...
                  software, and design, are owned by ENDevo or our licensors and
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  ...
                  personal, non-commercial use, subject to these Terms. This
                  license does not include any right to:
                </p>
                <ul className="list-disc pl-6 mb-4 space-y-2 text-gray-700">
                  <li>Resell or commercial use of the Services</li>
                  <li>
                    Copy, reproduce, or distribute content from the Services
                  </li>
                  <li>Modify or create derivative works</li>
                  <li>
                    Download (other than page caching) or reverse engineer any
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  ...
                  store through the Services ("Your Content"). By providing Your
                  Content, you grant ENDevo a worldwide, non-exclusive,
                  royalty-free license to use, store, reproduce, and process
                  Your Content solely to provide and improve the Services.
                </p>
                <p className="text-gray-700 leading-relaxed">
              ...
              <div className="mb-12">
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  ...
                  of purchase. All fees are non-refundable unless otherwise
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  If you purchase a subscription, you will be billed
                  automatically at the beginning of each billing cycle. You may
                  cancel your subscription at any time, but you will not receive
                ...
                <p className="text-gray-700 leading-relaxed">
                  We reserve the right to change our fees at any time. We will
                  provide you with reasonable notice of any fee changes, and the
                  new fees will apply to subsequent billing periods.
                </p>
              </div>
              ...
              <div className="mb-12">
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  ...
                  services, or professional service providers (such as
                  attorneys, financial advisors, or grief counselors). These
                  third parties are independent contractors, not employees or
                  agents of ENDevo.
                </p>
                <p className="text-gray-700 leading-relaxed mb-4">
                  We do not control, endorse, or assume responsibility for any
                  third-party services or content. Your interactions with third
                  parties are solely between you and them. We encourage you to
                  review the terms and privacy policies of any third-party
                  services you use.
                </p>
              </div>
              ...
              <div className="mb-12">
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  TO THE MAXIMUM EXTENT PERMITTED BY LAW, ENDEVO AND ITS
                  OFFICERS, DIRECTORS, EMPLOYEES, AGENTS, AND AFFILIATES SHALL
                  NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL, SPECIAL,
                  CONSEQUENTIAL, OR PUNITIVE DAMAGES, OR ANY LOSS OF PROFITS,
                  REVENUE, DATA, OR USE, ARISING OUT OF OR RELATED TO THESE
                  TERMS OR THE SERVICES, WHETHER BASED ON WARRANTY, CONTRACT,
                  TORT, OR ANY OTHER LEGAL THEORY, EVEN IF WE HAVE BEEN ADVISED
              ...
              <div className="mb-12">
                ...
                <p className="text-gray-700 leading-relaxed">
                  You agree to defend, indemnify, and hold harmless ENDevo and
                  ...
                  arising out of or related to: (a) your use of the Services;
                  (b) your violation of these Terms; (c) your violation of any
                  rights of another person or entity; or (d) Your Content.
                </p>
              </div>
              ...
              <div className="mb-12">
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  If you have a dispute with ENDevo, you agree to first contact
                  us at{" "}
                  <a
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  ...
                  these Terms or the Services will be resolved through binding
                ...
                <p className="text-gray-700 leading-relaxed">
                  YOU AND ENDEVO AGREE THAT ANY PROCEEDINGS TO RESOLVE DISPUTES
              ...
              <div className="mb-12">
                ...
                <p className="text-gray-700 leading-relaxed">
                  ...
                  conflict of law provisions. Any disputes not subject to
                  arbitration shall be resolved exclusively in the state or
              ...
              <div className="mb-12">
                ...
                <ul className="list-disc pl-6 mb-4 space-y-2 text-gray-700">
                  ...
                  <li>
                    We may delete your account and Your Content in accordance
                    with our data retention policies
                  </li>
                  <li>
                    Any fees paid are non-refundable (unless required by law)
                  </li>
                  <li>
              ...
              <div className="mb-12">
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  ...
                  entire agreement between you and ENDevo regarding the
                  Services.
                </p>
                ...
                <p className="text-gray-700 leading-relaxed mb-4">
                  ...
                  extent possible, and the other provisions will remain in full
                  force and effect.
                </p>
              ...
              <div className="bg-gray-50 border-l-4 border-brand-teal p-6 rounded-r-lg">
                ...
                <p className="text-gray-700 leading-relaxed">
                  By using ENDevo's Services, you acknowledge that you have read
                  these Terms of Service, understand them, and agree to be bound
                  by them. If you do not agree to these Terms, you must not
