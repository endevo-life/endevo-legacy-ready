      ...
      <main className="pt-16">
        ...
        <section className="py-20 bg-background">
          <div className="container max-w-7xl mx-auto px-4">
            ...
            >
              ...
              >
                <img
                  src="https://assets.cdn.filesafe.space/f5ehsbHfdFg2UsHEIb49/media/699757fe4c2502efdc96be1b.jpg"
              ...
              >
                ...
                <p className="text-xl text-brand-orange font-semibold">
                  Unlock pre-qualified clients, streamline operations, and
                  strengthen trust with the people who need you most.
                </p>

                <p className="text-lg text-muted-foreground leading-relaxed">
                  ENDevo connects service providers with pre-qualified clients
                  who are ready for your expertise. Our platform improves
                  onboarding efficiency, strengthens client trust through
                  seamless integration, and reduces the time you spend on
                  administrative paperwork so you can focus on delivering
                  exceptional service.
                </p>
        ...
        <section ref={statsAnimation.elementRef} className="py-20">
          <div className="container max-w-7xl mx-auto px-4">
            <div className="text-center space-y-12">
              ...
              >
                Clients expect{" "}
                <span className="text-brand-orange">guidance</span>. Most aren't
                prepared.
              </h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                >
                  <CardContent className="px-3 py-16 text-center space-y-4">
                    ...
                    <p className="text-lg text-black">
                      70% of clients arrive without organized documents, slowing
                      every process.
                    </p>
                  </CardContent>
                </Card>
                ...
                >
                  <CardContent className="px-3 py-16 text-center space-y-4">
                    ...
                    <p className="text-lg text-black">
                      Advisors spend up to 40% of time chasing paperwork instead
                      of providing value.
                    </p>
                  </CardContent>
                </Card>
                ...
                >
                  <CardContent className="px-3 py-16 text-center space-y-4">
                    ...
                    <p className="text-lg text-black">
                      60% of clients expect digital guidance but most providers
                      lack the tools.
                    </p>
                  </CardContent>
                </Card>
                ...
                >
                  <CardContent className="px-3 py-16 text-center space-y-4">
                    ...
                    <p className="text-lg text-black">
                      1 in 3 legal or financial cases is delayed due to missing
          ...
          <div className="container max-w-7xl mx-auto px-4">
            <div className="text-center space-y-12">
              ...
              <div className="grid lg:grid-cols-2 gap-12 items-center">
                ...
                >
                  ...
                  <div className="flex gap-6 items-start">
                    ...
                    <p className="text-lg text-foreground leading-relaxed text-left">
                      We are addressing a market valued at over 126 billion
                      dollars, combining traditional estate and legacy planning
                      with digital preparedness.
                    </p>
                  </div>
                  ...
                  <div className="flex gap-6 items-start">
                    ...
                    <p className="text-lg text-foreground leading-relaxed text-left">
                      Multiple revenue streams are available through individual
                      subscriptions, corporate partnerships, and enterprise
                      solutions.
                    </p>
                  </div>
                  ...
                  <div className="flex gap-6 items-start">
                    ...
                    <p className="text-lg text-foreground leading-relaxed text-left">
                      ENDevo combines financial opportunity with social impact
                      by solving a real human problem that affects every person,
                ...
                >
                  <img
                    src="https://assets.cdn.filesafe.space/f5ehsbHfdFg2UsHEIb49/media/699757fedf9bdf4f2b10a62f.jpg"
                    alt="Investment meeting collaboration"
                    className="w-full h-auto rounded-2xl shadow-lg"
                  />
                </div>
              </div>
        ...
        >
          <div className="container max-w-7xl mx-auto px-4 mb-8">
            <h2
              className={`text-3xl md:text-4xl font-bold text-brand-orange text-center transition-all duration-1000 ${barAnimation.isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"}`}
            >
          ...
          >
            ...
            >
              By joining ENDevo, you are not only investing in a company but
              also in a movement to bring clarity, confidence, and preparedness
              to millions of people. This is your chance to participate in
              shaping a new market while generating both financial return and
              meaningful impact.
            </p>
          </div>
        </section>
