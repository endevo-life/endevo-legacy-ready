            ...
            <div className="prose prose-lg max-w-none">
              ...
              <div className="mb-12">
                <p className="text-gray-700 leading-relaxed mb-6 text-lg">
                  ENDevo Inc. ("ENDevo," "we," "us," or "our") uses certain web
                  monitoring and tracking technologies, such as cookies,
                  beacons, pixels, tags, and scripts (collectively, "Cookies").
                  These technologies are used to provide, maintain, and improve
                  our wellness and legacy preparedness platform at{" "}
                  <span className="text-brand-orange font-semibold">
                    endevo.life
                  </span>{" "}
                  (the "Services"), optimize our offerings and personalized
                  recommendations, and provide our visitors and users ("you,"
                  "your") with a better experience.
                </p>
                <p className="text-gray-700 leading-relaxed mb-6">
                  This Cookie Policy explains how ENDevo uses Cookies and
                  similar technologies. For questions, please email{" "}
                  <a
                ...
                <div className="bg-brand-orange/10 border-l-4 border-brand-orange p-6 rounded-r-lg">
                  ...
                  <p className="text-gray-700 leading-relaxed">
                    ...
                    preferences, analyze platform usage, and deliver relevant
                    wellness content. You control which cookies you accept
                    through our cookie banner and settings.
                  </p>
                </div>
              </div>
              ...
              <div className="mb-12">
                ...
                <p className="text-gray-700 leading-relaxed mb-6">
                  Cookies allow websites to remember your actions and
                  ...
                  <ul className="space-y-3 text-gray-700">
                    ...
                    <li className="flex gap-3">
                      ...
                      <span>
                        ...
                        domain other than the one you're visiting
                      </span>
                    </li>
                  </ul>
                </div>
              ...
              <div className="mb-12">
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      Some cookies are essential for our website to function
                      properly. These enable basic features like page
                      navigation, access to secure areas, and remembering your
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      ...
                      such as your language preference, so we can provide you
                  ...
                  <div>
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      We may use cookies to deliver relevant advertisements and
              ...
              <div className="mb-12">
                ...
                <div className="mb-8">
                  <div className="bg-brand-navy/5 border-l-4 border-brand-navy p-6 rounded-r-lg mb-4">
                    ...
                    <p className="text-gray-700 leading-relaxed mb-4">
                      ...
                      you to browse our website and use its features. Without
                      these cookies, services you have asked for cannot be
                      provided.
                    </p>
                    <p className="text-gray-700 leading-relaxed mb-4">
                      <strong>Can be disabled:</strong> No - these cookies are
                ...
                <div className="mb-8">
                  <div className="bg-brand-teal/5 border-l-4 border-brand-teal p-6 rounded-r-lg mb-4">
                    ...
                    <p className="text-gray-700 leading-relaxed mb-4">
                      <strong>Purpose:</strong> These cookies enable enhanced
                      functionality and personalization, such as remembering
                      your preferences and settings.
                    </p>
                    <p className="text-gray-700 leading-relaxed mb-4">
                      <strong>Can be disabled:</strong> Yes - but this may
                ...
                <div className="mb-8">
                  <div className="bg-purple-50 border-l-4 border-purple-500 p-6 rounded-r-lg mb-4">
                    ...
                    <p className="text-gray-700 leading-relaxed mb-4">
                      <strong>Purpose:</strong> These cookies collect
                      information about how visitors use our website, helping us
                      understand patterns and improve our services.
                    </p>
                    <p className="text-gray-700 leading-relaxed mb-4">
                ...
                <div className="mb-8">
                  <div className="bg-brand-orange/10 border-l-4 border-brand-orange p-6 rounded-r-lg mb-4">
                    ...
                    <p className="text-gray-700 leading-relaxed mb-4">
                      <strong>Purpose:</strong> These cookies are used to
                      deliver advertisements more relevant to you and your
                      interests. They may also limit the number of times you see
                      an advertisement.
                    </p>
                    <p className="text-gray-700 leading-relaxed mb-4">
                      <strong>Can be disabled:</strong> Yes
                ...
                <div className="space-y-6">
                  <div className="bg-gray-50 border border-gray-200 rounded-lg p-6">
                    ...
                    <p className="text-gray-700 leading-relaxed mb-3">
                      ...
                      being used and to improve the user experience. Google
                      Analytics collects information anonymously and reports
                  ...
                  <div className="bg-gray-50 border border-gray-200 rounded-lg p-6">
                    ...
                    <p className="text-gray-700 leading-relaxed mb-3">
                      We may use cookies from social media platforms (Facebook,
                      LinkedIn, Instagram, etc.) to enable social sharing
                      features and deliver targeted advertisements.
                    </p>
                    <p className="text-sm text-gray-600">
                      Each platform has its own privacy policy governing their
                      use of cookies.
                    </p>
                  </div>
                  ...
                  <div className="bg-gray-50 border border-gray-200 rounded-lg p-6">
                    ...
                    <p className="text-gray-700 leading-relaxed mb-3">
                      We work with advertising partners to deliver relevant
                      advertisements. These partners may use cookies to collect
                      information about your browsing activities across
                      different websites.
                    </p>
                  </div>
                </div>
                ...
                <div className="space-y-6">
                  <div>
                    ...
                    <ul className="list-disc pl-6 mb-4 space-y-2 text-gray-700">
                      <li>
                        <strong>Accept All:</strong> Allow all cookies including
                        optional ones
                      </li>
                      <li>
                        <strong>Reject Non-Essential:</strong> Only allow
                        strictly necessary cookies
                      </li>
                      <li>
                        <strong>Customize:</strong> Choose which categories of
                  ...
                  <div className="bg-brand-orange/10 border-l-4 border-brand-orange p-6 rounded-r-lg">
                    ...
                    <ul className="space-y-2 text-gray-700">
                      ...
                      <li>
                        • <strong>Microsoft Edge:</strong> Settings → Privacy,
                        search, and services → Cookies
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="bg-yellow-50 border-l-4 border-yellow-500 p-6 rounded-r-lg">
                    ...
                    <p className="text-gray-700 leading-relaxed">
                      If you disable cookies, some features of our website may
                      not function properly. Strictly necessary cookies cannot
                      be disabled as they are essential for the website to work.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="mb-12">
                ...
                <p className="text-gray-700 leading-relaxed mb-6">
                  ...
                  have your online activity tracked.
                </p>
                <p className="text-gray-700 leading-relaxed mb-6">
                  Because there is not yet a common understanding of how to
                  interpret DNT signals, we do not currently respond to browser
                  DNT signals. However, you can use the cookie management
                  options described in this policy to control tracking
                  technologies.
                </p>
                <p className="text-gray-700 leading-relaxed">
                  We support the Global Privacy Control (GPC) signal. If your
                  browser sends a GPC signal, we will honor it by automatically
