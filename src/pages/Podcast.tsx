...
const Podcast = () => {
  ...
  useEffect(() => {
    const fetchRSS = async () => {
      ...
      const channelItunesImage = channel
        ? getByLocalName(channel, "image")
        : undefined;
      const channelImg =
      ...
      <section className="bg-[#0d1b2e] text-white pt-28 pb-14 px-4">
        <div className="container max-w-5xl mx-auto">
          <div className="flex items-center gap-2 mb-4">
            ...
            <span className="text-[#FF5A00] text-xs font-bold tracking-widest uppercase">
          ...
          <p className="text-gray-400 text-sm">
            Hosted by{" "}
            <span className="font-semibold text-white">Niki Weiss</span> · by
            ENDevo
          </p>
        </div>
      </section>
            ...
            {paginated.map((ep) => (
              ...
              >
                ...
                <div className="p-4 flex flex-col flex-1">
                  ...
                  <h3 className="text-base font-semibold mb-2 flex-1 line-clamp-3 leading-snug">
                    {ep.title}
                  </h3>
