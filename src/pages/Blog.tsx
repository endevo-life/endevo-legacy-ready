...
import { useBlogPosts, type SanityBlogPost } from "@/hooks/useBlogPosts";
...
const Blog = () => {
  ...
  const handleReadNow = (post: SanityBlogPost) => {
    if (post.content) {
    ...
    <div className="min-h-screen bg-background">
            ...
            {paginatedPosts.map((post) => (
              ...
              >
                <div className="w-full h-48 sm:h-56 md:h-[220px] lg:h-[294px] overflow-hidden bg-gray-100">
                  <img
                    src={urlFor(post.image).width(740).height(588).fit("crop").url()}
                    alt={post.title}
      ...
      {selectedPost && (
        ...
        >
          ...
          >
            <img
              src={urlFor(selectedPost.image).width(896).height(400).fit("crop").url()}
            ...
            <div className="p-4 sm:p-8">
              ...
              <div className="mt-4 flex flex-wrap items-center gap-3">
                ...
                {/* Facebook */}
                <a
                  href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(selectedPost.externalLink ?? "")}`}
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                {/* X (Twitter) */}
                <a
                  href={`https://twitter.com/intent/tweet?url=${encodeURIComponent(selectedPost.externalLink ?? "")}&text=${encodeURIComponent(selectedPost.title)}`}
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                {/* LinkedIn */}
                <a
                  href={`https://www.linkedin.com/sharing/share-offsite/?url=${encodeURIComponent(selectedPost.externalLink ?? "")}`}
                  target="_blank"
                  rel="noopener noreferrer"
